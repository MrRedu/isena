...
export const TemperatureIcon = ({ className }) => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" id="Capa_1" data-name="Capa 1" viewBox="0 0 40 40" fill="none" stroke="currentColor" className={className} strokeLinecap="round" strokeLinejoin="round" strokeWidth="3">
      <path className="cls-2" d="M24.26,23.84c0-.08.02-.15.02-.23V7.4c0-2.39-1.95-4.34-4.34-4.34s-4.34,1.95-4.34,4.34v16.21c0,.11.02.21.03.31-1.75,1.32-2.88,3.41-2.88,5.77,0,4,3.24,7.24,7.24,7.24s7.24-3.24,7.24-7.24c0-2.41-1.18-4.53-2.99-5.85Z" />
