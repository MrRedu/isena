...
CREATE TABLE `tbl_alturas` (
  ...
  `fecha_registro` timestamp NOT NULL DEFAULT current_timestamp() COMMENT 'Fecha del registro en la tabla de alturas',
...
CREATE TABLE `tbl_pesos` (
  ...
  `fecha_registro` timestamp NOT NULL DEFAULT current_timestamp() COMMENT 'Fecha del registro en la tabla de pesos',
  FOREIGN KEY (`cedula_paciente`) REFERENCES `tbl_pacientes`(`cedula_paciente`)
...
CREATE TABLE `tbl_temperaturas` (
  ...
  `fecha_registro` timestamp NOT NULL DEFAULT current_timestamp() COMMENT 'Fecha del registro en la tabla de temperaturas',
  FOREIGN KEY (`cedula_paciente`) REFERENCES `tbl_pacientes`(`cedula_paciente`)
...
CREATE TABLE `tbl_frecuencias_respiratorias` (
  ...
  `fecha_registro` timestamp NOT NULL DEFAULT current_timestamp() COMMENT 'Fecha en que se realizó el registro',
  FOREIGN KEY (`cedula_paciente`) REFERENCES `tbl_pacientes`(`cedula_paciente`)
